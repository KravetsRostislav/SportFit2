...
{
    public class ProducerChatService : IProducerChatService, IDisposable
    {
        private IProducer<Null, string> _producer;
        private string _topic;
        Logger _logger = LogManager.GetCurrentClassLogger();

        public ProducerChatService(IConfiguration config)
        {
        ...
        public Task<DeliveryResult<Null, string>> Produce(Message<Null, string> message)
        {
            _logger.Info($"ProducerChatService. Produce Message To Kafka: {message.Value}");
